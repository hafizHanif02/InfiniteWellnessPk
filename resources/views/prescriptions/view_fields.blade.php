<div class="row">
    <div class="col-md-4 col-sm-6 co-12">
        ...
        <h3>{{ !empty($prescription->doctor->doctorUser->full_name) ? $prescription->doctor->doctorUser->full_name :''}}</h3>
    ...
    <div class="col-md-4 co-12 mt-md-0 mt-5">
        @if(empty($prescription->doctor->address->address1) && empty($prescription->doctor->address->address2) && empty($prescription->doctor->address->city))
            {{ __('messages.common.n/a') }}
        @else
