        ...
        $(document).ready(function() {
            ...
            $("#prescription_id").change(function() {
                ...
                <tr scope="row" id="medicine-row${items}">
                    ...
                    <td>
                        <input type="number" step="any"onkeyup="discountCalculation(${items})" id="discount_percentage${items}" value="${medicine.medicine.product.fixed_discount}" class="form-control"  name="products[${items}][discount_percentage]" >
                    ...
                    <td>
                        <input type="number" readonly step="any"onkeyup="gstCalculation(${items})" id="gst_percentage${items}" value="${medicine.medicine.product.sale_tax_percentage}" class="form-control"  name="products[${items}][gst_percentage]" >
