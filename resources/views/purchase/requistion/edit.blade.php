<x-layouts.app title="Edit Requistion">
    @push('styles')
    ...
    <div class="container-fluid">
        <div class="card">
            <div class="card-header d-flex justify-content-between">
                <h3>Edit Requistion</h3>
                <a href="{{ route('purchase.requistions.index') }}" class="btn btn-secondary">Back</a>
            </div>
            <div class="card-body">
                <form action="{{ route('purchase.requistions.update', $requistion->id) }}" method="POST"
                    ...
                    <div class="row mb-5">
                        ...
                        {{-- <div class="col-md-4">
                            ...
                            <select name="vendor_id" readonly id="vendor_id" class="form-control" value="{{ old('vendor_id') }}"
                                required>
                                @forelse ($vendors as $vendor)
                                    <option value="{{ $vendor->id }}"
                                        {{ $requistion->vendor_id == $vendor->id ? 'selected' : '' }}>
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" name="vendor_id" readonly class="form-control" value="{{ $requistion->vendor->id }}" id="vendor" readonly
                                title="vendor_id">
                        </div>
                        <div class="col-md-4">
                            <label for="manufacturer" class="form-label">Manufacturer</label>
                            <input type="text" name="manufacturer" readonly class="form-control" value="{{ $requistion->vendor->manufacturer->company_name }}" id="manufacturer" disabled
                                title="Manufacturer">
                        </div>
                    </div>
                    <div class="row mb-5">
