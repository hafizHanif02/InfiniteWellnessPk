    ...
    <div class="container-fluid">
        <div class="card">
            <div class="card-header d-flex justify-content-between">
                ...
                <a href="{{ route('purchase.good_receive_note.index') }}" class="myBtnSecondary">Back</a>
            </div>
            <div class="card-body">
                <form id="save-goodreceivenote-form"
                    ...
                    <div class="mb-5">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <button type="button" id="requistion-btn" class="myBtnPrimary">
                    ...
                    <div class="d-flex justify-content-center mt-5">
                        <a href="{{ route('purchase.good_receive_note.index') }}" class="myBtnDanger">Cancel</a>
