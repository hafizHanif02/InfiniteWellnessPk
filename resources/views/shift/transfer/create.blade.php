        ...
        <script>
                        ...
                        success: function(response) {
                            ...
                            $("#add-products").append(`
                                    <tr id="${response.product.id}">
                                        ...
                                        <input type="hidden" id="tradeprice${items}" value="${response.product.trade_price}">
            ...
            function changeType(id, items) {
                ...
                if (unit_of_measurement == 1) {
                    ...
                    // BOX
                    $("#" + id + " input[name='products[" + items + "][price_per_unit]']").val((amount * pieces_per_pack).toFixed(2));
                    $("#" + id + " input[name='products[" + items + "][price_per_unit2]']").attr('onkeyup',
                        'changeQuantityPerPack(' + id + ',' + items + ')').val((amount * pieces_per_pack).toFixed(2));
